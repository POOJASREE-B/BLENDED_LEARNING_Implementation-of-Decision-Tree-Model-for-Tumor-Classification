...
## Algorithm
1. Import the neceaary python libraries
2. Load the dataset
3. Do required Data Preprocessing
4. Train the model using Decision Tree
...
## Output:
![image](https://github.com/user-attachments/assets/5615ce17-39fc-4513-bb1b-f2fd16844c9a)
